...
const authConfig = require('../configs/authEnv');
...
module.exports = (sequelize, DataTypes) => {
  const User = sequelize.define(
    'User',
    {
      ...
      gender: DataTypes.ENUM(appTypes.genders),
      race: DataTypes.ENUM(appTypes.races),
      maritalStatus: DataTypes.ENUM(appTypes.maritalStatus),
      degreeInstruction: DataTypes.ENUM(appTypes.degreeInstruction),
    },
    {
      sequelize,
  ...
  User.associate = function associate(models) {
    this.hasMany(models.Phone, { foreignKey: 'userId', as: 'userPhone' });
    this.hasMany(models.Address, { foreignKey: 'userId', as: 'userAddress' });
    this.hasMany(models.Dream, { foreignKey: 'userId', as: 'userDream' });
